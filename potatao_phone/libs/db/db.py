...
def db_create(db):
    ...
    default_items = [
        (1, 0, 'WiFi',  0, 'link_wifi', 'sd'),
        (2, 0, 'NRF mess',   1, 'link', 'sd'),
        (3, 0, 'SD Card',    2, 'link', 'sd'),
        (4, 0, 'Settings',   3, 'link', 'sd'),
        (5, 0, 'Extra',      4, 'link', 'sd'),
        (6, 4, 'Volume',     1, 'volume_state', 'sd'),
        (7, 4, 'Nickname',   2, 'change_nickname', 'sd'),
        (8, 4, 'Back',       3, 'pop_back', 'sd'),
        (9, 2, 'receive  NRF',       0, 'receive_nrf', 'sd'),
        (10, 2, 'send to NRF', 1, 'link', 'sd'),
        (11, 3, 'recordings',    0, 'get_sdcard_data', 'sd'),
        (12, 3, 'received',    1, 'get_sdcard_data', 'sd'),
    ...
    for item in default_items:
        ...
        insert_statements += f"INSERT INTO potatao_ui VALUES ({item[0]}, {item[1]}, '{item[2]}', {item[3]}, '{item[4]}', '{item[5]}');"
